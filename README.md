...
- **Local by Default:** SunReactor does all the daylight math locally, whether you pick a built-in city or enter your exact coordinates. Getting weather data is optional. If you want cloud adjustments, the daemon will connect directly to the OpenWeather API to fetch what it needs. Turn this off, and the program remains completely offline.
